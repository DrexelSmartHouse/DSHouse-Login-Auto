...
def sendEmail(id):
	...
	msg['From'] = 'info@drexelsmarthouse.com'
	...
	html = """\
		...
		<br>
		If you have not already done so,&nbsp;also be sure to join us on <a href="https://dragonlink.drexel.edu/organization/drexel-smart-house" target="_blank">DragonLinks</a><br>
		<br>
		Sincerely,&nbsp;<br>
	...
	s.starttls()
	s.login('info@drexelsmarthouse.com','***************')
	s.sendmail('info@drexelsmarthouse.com', id.lower()+'@drexel.edu', msg.as_string())
	s.quit()